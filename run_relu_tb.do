...
vlog -sv +acc \
    ...
    tb/cnn_accelerator_relu_tb.sv

# --- 3. Elaborate + load ----------------------------------------------------
vsim -voptargs=+acc work.cnn_accelerator_relu_tb

# --- 4. Waves ----------------------------------------------------------------
add wave -r sim:/cnn_accelerator_relu_tb/*
...
echo "Look for '=== PASS A: relu_enable = 0 ===' and '=== PASS B: relu_enable = 1 ==='"
echo "in the transcript to see each pass's results separately."
