# --- 0. Anchor to the repo root, relative to THIS file's location ----------
...
vlog -sv +acc \
    ...
    tb/cnn_accelerator_saturation_tb.sv

# --- 3. Elaborate + load ----------------------------------------------------
vsim -voptargs=+acc work.cnn_accelerator_saturation_tb

# --- 4. Waves ----------------------------------------------------------------
add wave -r sim:/cnn_accelerator_saturation_tb/*
...
echo "Done. Check the transcript above for TEST PASSED / TEST FAILED, and the"
echo "labeled 'SATURATION BOUNDARY CHECKS' block for the six named boundary results."
